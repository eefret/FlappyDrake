	...
	private void createActor() {
		...
		/*dandelion.registerUpdateHandler(new IUpdateHandler() {
			...
			public void onUpdate(float pSecondsElapsed) {
                ...
                if(dandelionBody.getLinearVelocity().y > 5){
                    dandelion.setCurrentTileIndex(0);
                    dandelion.setRotation(-15.0f);
                }else if(dandelionBody.getLinearVelocity().y >-1.5 && dandelionBody.getLinearVelocity().y <1.5){
                    dandelion.setCurrentTileIndex(1);
                    dandelion.setRotation(0);
                }else if(dandelionBody.getLinearVelocity().y < -5){
                    dandelion.setCurrentTileIndex(1);
                    dandelion.setRotation(15);
                }
        ...
        //drakeBody = PhysicsFactory.createBoxBody()
